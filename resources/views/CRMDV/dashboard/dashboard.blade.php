...
@section('main')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <ul class="list-group">
                    ...
                    @if(in_array('codes_view', $permissions))
                        <li class="list-group-item home__li3">
                    ...
                    @if(in_array('bao_cao_dan_khach_view', $permissions))
                        <li class="list-group-item home__li4">
                    ...
                    @if(in_array('hradmin_view', $permissions))
                        <li class="list-group-item home__li5">
            ...
            <div class="col-md-4">
                <ul class="list-group">
                    <!-- 2 thẻ li cột dưới cùng -->
                    @if(in_array('role_view', $permissions))
                        <li class="list-group-item home__li6">
                    ...
                    @if(in_array('setting', $permissions))
                        <li class="list-group-item home__li7">
                            <a href="/admin/setting" class="home__a">
                            <span class="home__svg__setting"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="16"
                                                                  viewBox="0 0 512 512">
                                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
                                <path
