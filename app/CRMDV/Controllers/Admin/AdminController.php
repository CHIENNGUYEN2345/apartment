...
use Session;
use Validator;
use App\CRMDV\Models\DailyWorkReport;
...
class AdminController extends CURDBaseController
{
    ...
    public function getIndex(Request $request)
    {
        ...
        /*RoleAdmin::whereIn('role_id', [3, 4])->delete();
        $not_customer = RoleAdmin::where('role_id', 3)->pluck('admin_id')->toArray();
        dd(Admin::whereIn('id', $not_customer)->get());
        Admin::whereIn('id', $not_customer)->delete();

        $not_customer = RoleAdmin::where('role_id', 4)->pluck('admin_id')->toArray();
        Admin::whereIn('id', $not_customer)->delete();
        ...
        return view('CRMDV.admin.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.admin.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.admin.edit')->with($data);
            } else if ($_POST) {
